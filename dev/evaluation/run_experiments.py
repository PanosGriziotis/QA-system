...
from evaluate import evaluate_retriever_ranker_pipeline, evaluate_pipeline
...
def run_retriever_evaluation(eval_filename, top_k_values = [x for x in range(1, 21)]):
    """
    ...
    retriever_configs = {
        ...
        "embedding_retriever_only_covid_qa": {
            "document_store": {
                "embedding_dim": 384
            },
            "retriever_class": EmbeddingRetriever,
            "retriever_args": {
                "embedding_model": "/home/pgriziotis/thesis/covid-va-chatbot/qa-subsystem/dev/retriever/adapted_retriever_only_covid_el"
            }
        },
        "dpr": {
            "document_store": {
...
def main():
    ...
    parser.add_argument("--eval_type", choices=['reader', "generator", 'retriever', "full_pipeline"], required=True,
